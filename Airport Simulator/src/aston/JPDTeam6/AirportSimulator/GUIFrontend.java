...
//            });
    ...
    private void initialize()
    {
        ...
        frmAirportSimulatorSetup.getContentPane().setLayout(new FormLayout(new ColumnSpec[] {
                FormFactory.RELATED_GAP_COLSPEC,
                ColumnSpec.decode("left:max(59dlu;min)"),
                FormFactory.RELATED_GAP_COLSPEC,
                ColumnSpec.decode("max(174dlu;pref):grow"),
                FormFactory.RELATED_GAP_COLSPEC,
